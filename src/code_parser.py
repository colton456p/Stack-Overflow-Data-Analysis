...
def generate_pdf_report(data_dict):
    ...
    for month, details in data_dict.items():
        ...
        for i in range(len(details['question'])):
            ...
            # Render text as HTML-compatible paragraphs
            ...
            story.append(Paragraph(f"<b>Answer Score:</b> {answer_score}", styles['BodyText']))
...
def sanitize_html(html_content):
    ...
    # Remove unsupported attributes like 'rel' and 'title' from <a> tags
