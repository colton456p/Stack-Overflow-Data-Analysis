...
def generate_pdf_report(data_dict):
    ...
    for month, details in data_dict.items():
        ...
        for i in range(len(details["question"])):
            ...
            copilot_answer_adj = details["copilot_answer_adj"] = copilot_info['adjectives']
            ...
            story.append(Paragraph(f"<b>Stack Overflow answer, Verb Count:</b> {so_answer_verb} , <b>Adjective Count:</b> {so_answer_adj}", styles["BodyText"]))
            story.append(Paragraph(f"<b>Stack Overflow Answer:</b> {so_answer}", body_text_style))
            story.append(Paragraph(f"<b>GPT answer, Verb Count:</b> {gpt_answer_verb} , <b>Adjective Count:</b> {gpt_answer_adj}", styles["BodyText"]))
            story.append(Paragraph(f"<b>GPT-4o Answer:</b> {gpt_answer}", body_text_style))
            story.append(Paragraph(f"<b>Co-Pilot, Verb Count:</b> {copilot_answer_verb} , <b>Adjective Count:</b> {copilot_answer_adj}", styles["BodyText"]))
            story.append(Paragraph(f"<b>Co-Pilot Answer:</b> {copilot_answer}", body_text_style))
